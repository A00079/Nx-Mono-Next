        ...
        <div className="bg-white">
            <div className="relative isolate px-6 pt-14 lg:px-8">
                ...
                <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                    ...
                    Announcing our next round of funding. <div className="font-semibold text-indigo-600 inline"><span className="absolute inset-0" aria-hidden="true"></span>Read more <span aria-hidden="true">&rarr;</span></div>
                    </div>
                </div>
